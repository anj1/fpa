...
if __name__ == "__main__":
    from fp_attention._power_attention.impl import attention as attention_cutlass, create_inputs as create_inputs_cutlass
    from fp_attention._power_attention.reference import attention_reference as attention_reference_old
    from fp_attention._power_attention.create_inputs import create_inputs
